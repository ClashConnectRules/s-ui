...
custom_version() {
    ...
    download_link="https://raw.githubusercontent.com/ClashConnectRules/s-ui/main/install.sh"
...
update_shell() {
    wget -O /usr/bin/s-ui -N --no-check-certificate https://github.com/ClashConnectRules/s-ui/raw/main/s-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
